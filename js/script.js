const global = {
  ...
  api: {
    apikey: "6e0af3c79bd2fb73b57bc38878d3c3f4",
...
async function search() {
  ...
  if (global.search.term !== "" && global.search.term !== null) {
    ...
    showAlert("Please Enter Valid Search Term", "error");
  }
}
...
function displayPagination() {
  ...
  //disabled prev button if button is on 1st page
  if (global.search.page === 1) {
    document.querySelector("#prev").disabled = true;
  }

  //disable  next button  if button is on last page
